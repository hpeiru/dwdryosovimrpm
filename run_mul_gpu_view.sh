...
# --name='two_view_long_share_d0.75_256_s1_lr0.01_decouple_balance_lambda768_e11_2w' \
...
# --g=0.9 \
# --lambd=0.0013 \
# --experiment_name='two_view_long_share_d0.75_256_s1_lr0.01_decouple_balance_lambda768_e11_2w' \
# --gpu_ids='0' \
...
## LPN + DWDR ##
# python train_mul_gpu.py \
# --name='two_view_long_share_d0.75_256_s1_lr0.003_lpn4_balance_decouple_e11_lambd768_offdiag' \
# --data_dir='/home/wangtingyu/datasets/University-Release/train' \
# --views=3 \
# --droprate=0.75 \
# --share \
...
# --block=4 \
# --lr=0.003 \
# --experiment_name='two_view_long_share_d0.75_256_s1_lr0.003_lpn4_balance_decouple_e11_lambd768_offdiag' \
# --gpu_ids='1' \
# --g=0.9 \
# --lambd=0.0013 \
# --balance \
...
## swin-b + DWDR ##
# python train_mul_gpu.py \
# --name='two_view_swin-b_long_share_d0.75_224_s1_lr0.005_balance_decouple_lambda512_e11_g0.9_offdiag' \
# --data_dir='/home/wangtingyu/datasets/University-Release/train' \
# --views=3 \
# --droprate=0.75 \
# --share \
...
# --g=0.9 \
# --lambd=0.002 \
# --experiment_name='two_view_swin-b_long_share_d0.75_224_s1_lr0.005_balance_decouple_lambda512_e11_g0.9_offdiag' \
# --gpu_ids='0' \
# --swin 
...
## LPN + mmamba + balance##
python train_mul_gpu.py \
--name='two_view_long_share_d0.75_256_s1_lr0.001_lpn4_balance_yosovim_rpmringgnos2' \
--data_dir='/home/zhoujiayu/datasets/University-Release/train' \
--views=3 \
--droprate=0.75 \
--share \
--stride=1 \
...
--block=4 \
--lr=0.001 \
--experiment_name='two_view_long_share_d0.75_256_s1_lr0.001_lpn4_balance_yosovim' \
--gpu_ids='0' \
--g=0.9 \
--lambd=0.0013 \
--balance \
...
python test_mul_gpu.py \
--name='two_view_long_share_d0.75_256_s1_lr0.001_lpn4_balance_yosovim_rpmringgnos2' \
--test_dir='/home/zhoujiayu/datasets/University-Release/test' \
--gpu_ids='0'